...
sys.path.insert(0, '/home/rnrqls-robot/ai_worker/monitor_ocr_a')
from paddleocr import PaddleOCR
from monitor_ocr_a.ocr_pipeline import find_display
from monitor_ocr_a.ocr_pipeline import process_frame
from monitor_ocr_a.ocr_pipeline_hq import process_frame_hq
from monitor_ocr_a.frame_aggregator import FrameAggregator
