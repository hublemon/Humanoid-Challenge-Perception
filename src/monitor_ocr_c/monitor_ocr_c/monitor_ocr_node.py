...
from monitor_ocr_c.paddle_compat import make_ocr

from monitor_ocr_c.ocr_pipeline import process_frame, init_yolo
from monitor_ocr_c.ocr_pipeline_hq import process_frame_hq
from monitor_ocr_c.ocr_pipeline_parts import process_frame_parts, PART_NAMES
from monitor_ocr_c.ocr_pipeline_sequence import process_frame_sequence, PEG_COUNT
from monitor_ocr_c.frame_aggregator import FrameAggregator, FrameAggregatorParts, FrameAggregatorSequence


class MonitorOCRNode(Node):

    def __init__(self):
        super().__init__('monitor_ocr_c_node')
        ...
        try:
            ...
            _default_model = os.path.join(
                get_package_share_directory('monitor_ocr_c'), 'best.pt')
        except Exception:
            _default_model = os.path.join(
