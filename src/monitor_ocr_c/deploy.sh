...
ROBOT_DEST="~/ai_worker/monitor_ocr_c"
...
$SSH "docker exec ai_worker bash -c \"
    cp -r ~/ai_worker/monitor_ocr_c /root/ros2_ws/src/ 2>/dev/null || true
    source /opt/ros/jazzy/setup.bash &&
    cd /root/ros2_ws &&
    colcon build --packages-select monitor_ocr_c 2>&1 | tail -5
\""
echo "      완료"
...
echo "     bash ~/ai_worker/monitor_ocr_c/run_ocr.sh"
echo ""
