...
def generate_launch_description() -> LaunchDescription:
    pipe_share = get_package_share_directory('perception_head_pipe')
    detector_share = get_package_share_directory('perception_part_detector')

    pipe_params = os.path.join(pipe_share, 'config', 'params.yaml')
    detector_params = os.path.join(detector_share, 'config', 'params.yaml')
    default_model = os.path.join(detector_share, 'weights', 'best.pt')
