#!/usr/bin/env python3
"""Launch bolt_hole_center_node with parameters from config/params.yaml."""
...
def generate_launch_description() -> LaunchDescription:
    pkg_share = get_package_share_directory('perception_wrist_targets')
    ...
    node = Node(
        package='perception_wrist_targets',
