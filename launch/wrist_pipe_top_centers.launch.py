...
def generate_launch_description() -> LaunchDescription:
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'debug_image_topic',
            default_value='/perception/wrist/pipe_top_centers_debug_image',
            description='Output debug Image topic.',
        ),
        DeclareLaunchArgument(
            'log_targets',
            default_value='false',
            description='Enable target publication logs.',
        ),
    ]
    ...
    node = Node(
        ...
        parameters=[
            LaunchConfiguration('params_file'),
            {
                ...
                'log_targets': ParameterValue(
                    LaunchConfiguration('log_targets'),
                    value_type=bool,
                ),
            },
        ],
